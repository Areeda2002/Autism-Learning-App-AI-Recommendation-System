...
class _GenderSelectionScreenState extends State<GenderSelectionScreen> {
  ...
  Future<void> _saveUserData() async {
    ...
    // Age constraint: child must be between 4 and 12
    final ageInt = int.tryParse(age);
    if (ageInt == null) {
      Get.snackbar("Invalid Age", "Please enter a valid number for age",
    ...
    if (ageInt < 4 || ageInt > 12) {
      Get.snackbar(
        "Age Out of Range",
        "Child's age must be between 4 and 12 years old",
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      style: TextStyle(fontSize: screenWidth * 0.041),
                      decoration: inputDecoration.copyWith(
                        hintText: "Age of your child? (4–12 years)",
                        helperText: "Child must be between 4 and 12 years old",
                      ),
